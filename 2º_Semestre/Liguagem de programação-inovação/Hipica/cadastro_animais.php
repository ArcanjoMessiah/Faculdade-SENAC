            ...
            <div class="card-group">
                <div class="card bg-dark text-white">
                    <div class="card-body">
                        ...
                        <input type="text" name="nomedoanimal" size="50" id="nomedoanimal" class="form-control">
                ...
                <div class="card bg-dark text-white">
                    <div class="card-body">
                        ...
                        <label for="nomeanteriordoanimal">Nome Anterior do Animal:</label>
                        <input type="text" name="nomeanteriordoanimal" size="50" id="nomeanteriordoanimal" class="form-control">

                        <label for="sexo"> Sexo: </label>
                        <br>
                        <div class="custom-control custom-radio custom-control-inline" style="margin-top:2px; ">

                            <input type="radio" class="custom-control-input" id="M" name="sexo" value="M">
                            <label class="custom-control-label" for="M">Masculino</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="F" name="sexo" value="F">
                            <label class="custom-control-label" for="F">Feminino</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" class="custom-control-input" id="N" name="sexo" value="N">
                            <label class="custom-control-label" for="N">Não declarado</label>
                        </div>
                        <br><br>
                        <label for="modalidade"> Modalidades: </label>

                        <label class="container">Salto(acima de 1m)
                            <input type="checkbox" value="salto">
